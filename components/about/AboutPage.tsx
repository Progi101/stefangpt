                ...
                <section id="features">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <FeatureCard icon={SparklesIcon} title="Limitless Creativity">
                            Bring your ideas to life with our integrated AI image generator. By simply typing a command like <code className="text-xs bg-gray-200 dark:bg-gray-700 p-1 rounded">generate a futuristic cityscape at sunset</code>, you can create a unique, high-quality image from your text description. This tool, powered by the advanced Stability AI's Stable Diffusion model, is perfect for writers seeking inspiration, presenters needing custom visuals, or anyone who wants to add a unique visual spark to their ideas. All generated images are saved to your personal library for easy access.
                        </FeatureCard>

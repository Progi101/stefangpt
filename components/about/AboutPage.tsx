                ...
                <section id="features">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <FeatureCard icon={SparklesIcon} title="Limitless Creativity">
                            Bring your ideas to life with our integrated AI image generator. By typing a command like <code className="text-xs bg-gray-200 dark:bg-gray-700 p-1 rounded">generate a futuristic cityscape</code>, you can create a unique image from your description. This tool is powered by the free, community-driven Stable Horde network, meaning your creativity is never limited by costs. As it's a volunteer network, generation can sometimes be slow, but it's a small price for truly unlimited access.
                        </FeatureCard>
